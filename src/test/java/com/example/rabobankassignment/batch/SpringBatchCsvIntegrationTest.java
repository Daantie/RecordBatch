...
import com.example.rabobankassignment.batch.config.SpringBatchCsvJobConfig;
...
@ContextConfiguration(classes = { SpringBatchConfig.class, SpringBatchCsvJobConfig.class })
class SpringBatchCsvIntegrationTest {
    ...
    void setUp() {
        ...
        this.jobLauncherTestUtils.setJob(csvBatchJob);
    ...
    void testCsvJob() throws Exception {
        ...
        Assertions.assertEquals("Duplicate reference", invalidRecordList.get(0).getReason());
        Assertions.assertEquals(112806, invalidRecordList.get(0).getReference());
        Assertions.assertEquals("Duplicate reference", invalidRecordList.get(1).getReason());
        Assertions.assertEquals(112806, invalidRecordList.get(1).getReference());
    }
}
